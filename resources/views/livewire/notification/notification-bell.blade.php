@if($mode === 'link')
    <flux:button variant="ghost" size="sm" icon="bell" class="relative" :href="route('notifications')" wire:navigate>
        @if($unreadCount > 0)
    ...
    <flux:dropdown>
        ...
        <flux:menu class="w-[320px] p-0">
            <div class="p-4 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center">
                ...
                @if($unreadCount > 0)
                    <flux:link href="{{ route('notifications') }}" size="xs" wire:navigate>Tout voir</flux:link>
                @endif
            </div>
            ...
            <div class="max-h-[400px] overflow-y-auto">
                ...
                @empty
                    <div class="p-8 text-center text-zinc-500">
                        <flux:subheading size="sm">Aucune notification</flux:subheading>
                    </div>
                @endforelse
            </div>
